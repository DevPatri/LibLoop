        ...
        <div class="flex justify-between h-16 items-center">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:ml-10 sm:flex">
                    ...
                    <a href="{{ route('dashboard.create') }}" class="custom-nav-link {{ request()->routeIs('dashboard.create') ? 'active' : '' }}">
                        {{ __('Subir libro') }}
                    </a>
                    <a href="{{ route('dashboard.userId', ['id' => Auth::user()->usuario_id]) }}" class="custom-nav-link {{ request()->routeIs('dashboard.userId') ? 'active' : '' }}">
                        {{ __('Libros subidos') }}
                    </a>
